...
import { Camera, MapPin, Clock, Smile, Meh, Frown } from "lucide-react";
                ...
                {[
                  ...
                  <button
                    ...
                    className={`w-10 h-10 rounded-lg border flex items-center justify-center transition-colors ${
                      sentiment === key ? "bg-primary border-primary text-primary-foreground" : "border-border text-muted-foreground hover:bg-muted"
                    }`}
                  >
                ...
                {["virtual", "in-person"].map((type) => (
                  <button
                    ...
                    className={`flex-1 py-2 text-xs font-medium transition-colors ${
                      meetingType === type ? "bg-primary text-primary-foreground" : "bg-card text-muted-foreground hover:bg-muted"
                    }`}
                  >
